...
test('identity', t => {
  ...
  t.is(Boolean(isaReadable(gen)), true, 'fun-promise: is readable')
  t.is(Boolean(isaWritable(gen)), true, 'fun-promise: is writable')
  t.is(Boolean(gen.then), true, 'fun-promise: is promise')
  t.is(Boolean(FunStream.isFun(gen)), true, 'fun-promise: isFun')
  t.done()
})
